...
## Design
Since i already had an idea of what kind of design i wanted and i already had a couple of wireframes set up, i decided to start with some non functional design coding using XAMPP, Atom, CSS, HTML and Bootstrap. Since i used Bootstrap, it was very easy to create a design as such:
